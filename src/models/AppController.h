...
protected:
    ...
    // Import probes/thumbs asynchronously; clips added immediately must pick up
    // filmstrip/thumbnail paths when AssetLibrary finishes generating them.
    void syncClipMediaFromAsset(const QString &assetId);
