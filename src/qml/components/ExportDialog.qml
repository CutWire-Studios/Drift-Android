    ...
    contentItem: Flickable {
        ...
        Column {
            ...
            Column {
                ...
                Item {
                    width: parent.width
                    // A ~17px strip is a fine mouse target and a poor finger one, and it
                    // is the only way to reach every encoder setting below it.
                    height: Math.max(advancedHeader.implicitHeight,
                                     Theme.touchUi ? 44 : advancedHeader.implicitHeight)
